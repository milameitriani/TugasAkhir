    ...
    <form class="card" wire:submit.prevent="save">
        ...
        <div class="card-body">
            ...
            <div class="form-group mb-3 row">
                ...
                <div class="col">
                    <input type="number" class="form-control @error('user.phone') is-invalid @enderror" placeholder="No. Telp" wire:model.defer="user.phone">
            ...
            <div class="form-group mb-3 row">
                ...
                <div class="col">
                    <textarea class="form-control @error('user.address') is-invalid @enderror" placeholder="Alamat" wire:model.defer="user.address"></textarea>
